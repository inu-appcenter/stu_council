    ...
    <div class="container">
      <div class="below_link">
        ...
        <div class="menubar">
          ...
          <li><router-link to="/petition?boardKind=1">소통창구</router-link>
            <ul>
              <router-link to="/petition?boardKind=1"><li>학생청원</li></router-link>
              <router-link to="/board?boardKind=2"><li>게시판</li></router-link>
            </ul>
          </li>
          <li><router-link to="/conference?boardKind=3">활동보고</router-link>
            <ul>
              <router-link to="/conference?boardKind=3"><li>회의보고</li></router-link>
              <router-link to="/financial?boardKind=4"><li>재정보고</li></router-link>
              <router-link to="/formdoc?boardKind=5"><li>서식자료실</li></router-link>
            </ul>
          </li>
          <li><router-link to="/rental?boardKind=6">학생복지</router-link>
            <ul>
              <router-link to="/rental?boardKind=6"><li>물품대여</li></router-link>
              <router-link to="/bus??boardKind=7"><li>통학버스 및 귀향버스</li></router-link>
            </ul>
          </li>
        </div>
      </div>
